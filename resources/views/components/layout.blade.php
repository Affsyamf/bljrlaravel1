...
<body class="flex flex-col min-h-screen">
  ...
  @endif
            ...
            <div class="flex items-center gap-4">
                ...
                <nav aria-label="Global" class="hidden md:block">
                    <ul class="flex items-center gap-6 text-sm">
                        ...
                        <li><x-nav-link href="/siswa/create">Create Siswa</x-nav-link></li>
                        <li><x-nav-link href="/siswa">Siswa</x-nav-link></li>
                    </ul>
                </nav>
                ...
                <button @click="mobileMenuOpen = !mobileMenuOpen" class="block rounded-md bg-gray-100 p-2.5 text-gray-600 transition hover:text-gray-600/75 md:hidden">
    ...
    <main class="flex-grow">
        ...
        <div class="mx-auto max-w-screen-xl py-10 px-4 sm:px-6 lg:px-8">
            {{ $slot }}
        </div>
    </main>
