...
<body>
  ...
  <div class="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-1 items-center justify-end md:justify-between">
      <nav aria-label="Global" class=" md:block">
        <ul class="flex items-center gap-6 text-xl">
          <li>
            <x-nav-link class="text-gray-500 transition hover:text-gray-500/75" :active="request()->is('/')" href="/"> Home </x-nav-link>
            </li>
            <li>
            ...
            <li>
            <x-nav-link class="text-gray-500 transition hover:text-gray-500/75" href="{{ route('siswa.index') }}" :active="request()->is('siswa')" > Siswa </x-nav-link>
            </li>
    ...
    {{-- <nav>
        <x-nav-link href="/" active='123' :highlight="false" >
            Home
        </x-nav-link>
